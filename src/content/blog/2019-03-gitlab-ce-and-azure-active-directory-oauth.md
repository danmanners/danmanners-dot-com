...
pubDate: 2019-03-02T16:20:30-05:00
...
![Azure Active Directory](/images/posts/gitlab-ce-and-azure-active-directory-oauth/01-ADD.png#center)


2. Navigate to **App registrations**.

![App registrations](/images/posts/gitlab-ce-and-azure-active-directory-oauth/02-App_registration.png#center)


3. Click on "**New application registration**"

![New application registration](/images/posts/gitlab-ce-and-azure-active-directory-oauth/03-Navigation.png#center)


4. Fill out the form similar to this and click create.

![Fill it all out](/images/posts/gitlab-ce-and-azure-active-directory-oauth/04-Configure.png#center)
...
![Application ID](/images/posts/gitlab-ce-and-azure-active-directory-oauth/05-Registrations.png#center)
...
![Reply URLs](/images/posts/gitlab-ce-and-azure-active-directory-oauth/06-Reply_URLs.png#center)
...
![Step 1](/images/posts/gitlab-ce-and-azure-active-directory-oauth/07-Keys.png#center)

![Step 2](/images/posts/gitlab-ce-and-azure-active-directory-oauth/08-Keys.png#center)
...
![Endpoint Navigation](/images/posts/gitlab-ce-and-azure-active-directory-oauth/03-Navigation.png#center)

![Endpoint Navigation](/images/posts/gitlab-ce-and-azure-active-directory-oauth/09-Endpoint.png#center)
